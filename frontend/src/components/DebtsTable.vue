  ...
  <div class="debt-table">
    ...
    >
                ...
                <v-container fluid>
                  <v-row>
                    ...
                    >
                      <v-select
                          v-model="form.type"
                          :items="['Credit Card', 'Student Loan', 'Car Loan', 'Mortgage', 'Personal Loan', 'Other']"
                          label="Debt Type"
                      ></v-select>
                    </v-col>
                    <v-col
                    ...
                    >
                      <v-text-field
                          v-model.number="form.monthlyMin"
                          label="Monthly Minimum"
                          validation-value="1.00"
                          prefix="$"
                      ></v-text-field>
                    </v-col>
                    <v-col
                    ...
                    >
                      <v-text-field
                          v-model.number="form.monthlyActual"
      ...
      <template v-slot:item.total="{ item }">
        <span v-if="item.raw.total > 0">{{ parseFloat(item.raw.total).toLocaleString('en-US', {style:"currency", currency:"USD"}) }}</span>
        <span v-else>0</span>
      </template>
